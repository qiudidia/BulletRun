...
const TRANSLATIONS: Dictionary = {
	...
	"buy": {"zh": "购买", "en": "Buy"},
	"owned": {"zh": "已购", "en": "Owned"},
	"kills_cost": {"zh": "%d 人头", "en": "%d Kills"},
	"shop_ammo": {"zh": "补满弹药", "en": "Refill Ammo"},
	"shop_ammo_desc": {"zh": "补满当前武器的弹匣+备用弹", "en": "Refill current weapon magazine + reserve ammo"},
	"shop_medkit": {"zh": "医疗包", "en": "Medkit"},
	"shop_medkit_desc": {"zh": "恢复 50 点生命值", "en": "Restore 50 HP"},
	"shop_damage": {"zh": "升级伤害", "en": "Upgrade Damage"},
	"shop_damage_desc": {"zh": "所有武器伤害 +10", "en": "All weapon damage +10"},
	"shop_infinite_ammo": {"zh": "无限子弹", "en": "Infinite Ammo"},
	"shop_infinite_ammo_desc": {"zh": "当前武器弹匣无限（仍可换弹显示）", "en": "Infinite magazine for current weapon"},
	"shop_nuke": {"zh": "核爆", "en": "Nuke"},
	"shop_nuke_desc": {"zh": "立即结束游戏，玩家已核爆", "en": "End game instantly, player nuked"},
	"shop_grenade": {"zh": "手榴弹", "en": "Grenade"},
	"shop_grenade_desc": {"zh": "获得 1 颗手榴弹（按 G 长按瞄准松开投掷）", "en": "Get 1 grenade (hold G to aim, release to throw)"},
	"shop_machinegun": {"zh": "机枪", "en": "Machine Gun"},
	"shop_machinegun_desc": {"zh": "解锁机枪武器（按 5 切换）", "en": "Unlock machine gun (press 5 to switch)"},
	...
	"loadout_name": {"zh": "配置名称", "en": "Loadout Name"},
