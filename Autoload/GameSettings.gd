...
const TRANSLATIONS: Dictionary = {
	...
	"about_zombie_desc": {"zh": "无尽的僵尸波次向你涌来！每 5 波出现精英僵尸（500 血量，更凶猛），每 10 波迎来 BOSS「幽灵」（10000 血量，身披披风，攻击力极强，还会扔手雷！）。击杀普通僵尸 +5 XP，击杀精英 +35 XP，击杀 BOSS +75 XP。波次间隙可进入商店，用积累的金钱购买步枪（300 分）、狙击枪（500 分）、机枪（400 分）和手榴弹来武装自己。开局只有一把手枪和 0 颗手雷，活下来靠你的枪法和策略！\n僵尸联机合作：最多 4 人组队（红/蓝/黄/绿），合作抵御无限波次，击杀奖励 XP 全队共享，队友血量显示在左下角。", "en": "Endless zombie waves! Every 5th wave spawns Elite zombies (500 HP, more aggressive). Every 10th wave brings the Boss 'Ghost' (10000 HP, wears a cape, devastating attacks, throws grenades!). Normal kill +5 XP, Elite kill +35 XP, Boss kill +75 XP. Between waves, visit the shop to buy Rifle (300 pts), Sniper (500 pts), Machinegun (400 pts) and Grenades. You start with only a pistol and 0 grenades — survive with skill and strategy!\nZombie Co-op: Up to 4 players (Red/Blue/Yellow/Green), XP rewards shared across the team. Teammate HP shown at bottom-left."},
	...
	"about_multiplayer_desc": {"zh": "局域网联机（UDP），支持三种模式：\n· 单挑模式 — 1v1 红蓝对决，先达到 25 击杀获胜，死亡后 3 秒重生。\n· 乱斗模式 — 3 人各打各的（红/蓝/黄），自由混战，击杀计分。\n· 僵尸合作 — 最多 4 人组队（红/蓝/黄/绿），合作抵御无限波次，死亡后可观战队友（按空格切换），全员阵亡才游戏结束。\n首次游戏需设置昵称（永久保存），联机大厅可自由选色，颜色冲突不可开始游戏。房主可切换游戏模式。", "en": "LAN multiplayer (UDP), three modes:\n· Duel — 1v1 Red vs Blue, first to 25 kills wins, respawn after 3s.\n· Brawl — 3 players free-for-all (Red/Blue/Yellow), kill scoring.\n· Zombie Co-op — Up to 4 players (Red/Blue/Yellow/Green), fight endless waves together. Spectate teammates after death (Space to switch), game ends only when all are dead.\nSet nickname on first launch (saved permanently). Pick colors freely in lobby, conflict prevents start. Host can switch game mode."},
